                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('hostel_id') is-invalid @enderror" id="hostel_id"
                                ...
                                @foreach ($hostels as $hostel)
                                    <option value="{{ $hostel->id }}" @selected(old('hostel_id', $student->hostel_id) == $hostel->id)>
                                        {{ $hostel->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('check_in_date') is-invalid @enderror"
                                ...
                                value="{{ old('check_in_date', $student->check_in_date) }}">
                            @error('check_in_date')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('check_out_date') is-invalid @enderror"
                                ...
                                value="{{ old('check_out_date', $student->check_out_date) }}">
