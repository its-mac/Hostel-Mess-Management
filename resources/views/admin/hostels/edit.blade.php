                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="name"
                                        ...
                                        placeholder="Enter hostel name" value="{{ old('name', $hostel->name) }}">
                                    @error('name')
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="warden"
                                        ...
                                        value="{{ old('warden', $hostel->warden) }}">
                                    @error('warden')
                                        <small class="invalid-feedback d-block">{{ $message }}</small>
                                    @else
                                ...
                                <div class="col-lg-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="contact"
                                            ...
                                            placeholder="Contact number" value="{{ old('contact', $hostel->contact) }}">
                                    </div>
                                    @error('contact')
                                        <small class="invalid-feedback d-block">{{ $message }}</small>
                                    @else
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <input type="number" name="rooms"
                                        ...
                                        placeholder="Total number of rooms" value="{{ old('rooms', $hostel->rooms) }}">
                                    @error('rooms')
                                        <small class="invalid-feedback d-block">{{ $message }}</small>
                                    @else
                                ...
                                <div class="col-lg-9">
                                    <div class="input-group search-form">
                                        <input type="number" name="capacity"
                                            ...
                                            placeholder="Total capacity" value="{{ old('capacity', $hostel->capacity) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="pincode"
                                    ...
                                    placeholder="Area pin code" value="{{ old('pincode', $hostel->pincode) }}">
                                @error('pincode')
                                    <small class="invalid-feedback d-block">{{ $message }}</small>
                                @else
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <textarea name="address" class="form-control @error('address') is-invalid @enderror" rows="3"
                                        placeholder="Enter hostel address">{{ old('address', $hostel->address) }}</textarea>
                                    @error('address')
                                        <small class="invalid-feedback d-block">{{ $message }}</small>
                                    @else
                                    ...
                                    <div>
                                        <div class="form-check form-check-inline">
                                            <input type="radio" id="hostelTypeBoys" name="type"
                                                ...
                                                {{ old('type', $hostel->type) == 'boys' ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" id="hostelTypeGirls" name="type"
                                                ...
                                                {{ old('type', $hostel->type) == 'girls' ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" id="hostelTypeCoed" name="type"
                                                ...
                                                {{ old('type', $hostel->type) == 'coed' ? 'checked' : '' }}>
