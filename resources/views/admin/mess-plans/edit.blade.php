...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="mb-0">Edit Mess Plan</h5>
                    </div>
                </div>
                <div class="col-md-12">
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5>Edit Mess Plan</h5>
            <a href="{{ route('mess-plans.index') }}" class="btn btn-sm btn-outline-secondary">Back</a>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            @endif
            <form method="POST" action="{{ route('mess-plans.update', $plan->id) }}">
                @csrf
                @method('PUT')
                <div class="mb-3">
                ...
                <div class="text-end">
                    ...
                    <a href="{{ route('mess-plans.index') }}" class="btn btn-light">Cancel</a>
                </div>
            </form>
        </div>
    </div>
