          ...
          <div class="col-sm-6">
            ...
            <div class="card">
              ...
              <div class="card-footer">
                ...
                <button class="btn btn-link-danger">Reset</button>
              </div>
            </div>
            <!-- HTML Input Types -->
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <input class="form-control" type="datetime-local" value="2025-07-31T14:30:00" id="demo-datetime-local">
                </div>
                <div class="mb-3">
                  <label for="demo-date-only" class="form-label">Date only</label>
                  <input class="form-control" type="date" value="2025-07-15" id="demo-date-only">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input class="form-control" type="month" value="2025-07" id="demo-month-only">
                </div>
                <div class="mb-3">
                  <label for="demo-week-only" class="form-label">Week only</label>
                  <input class="form-control" type="week" value="2025-W30" id="demo-week-only">
                </div>
                <div class="mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="mb-0">
                    ...
                    <datalist id="browsers">
                      <option value="Internet Explorer"> </option><option value="Firefox"> </option><option value="Chrome"> </option><option value="Opera"> </option><option value="Safari"> </option></datalist>
