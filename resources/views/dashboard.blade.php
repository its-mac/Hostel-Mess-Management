...
<head>
    ...
    <!-- <link rel="stylesheet" href="css/plugins/phosphor-icons.css" /> -->
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme="light">
                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item pc-hasmenu">
                        ...
                        <ul class="pc-submenu">
                            ...
                            <li class="pc-item"><a class="pc-link" href="../dashboard/ecommerce.html"
                                    data-i18n="Ecommerce">Ecommerce</a></li>
                            <li class="pc-item"><a class="pc-link" href="../dashboard/crm.html" data-i18n="CRM">CRM</a>
                            </li>
                    ...
                    <li class="pc-item pc-hasmenu">
                        ...
                        <ul class="pc-submenu">
                            ...
                            <li class="pc-item"><a class="pc-link" href="../demo/layout-2.html"
                                    data-i18n="Layouts 2">Layouts 2</a></li>
                            <li class="pc-item"><a class="pc-link" href="../demo/layout-3.html"
                                    data-i18n="Layouts 3">Layouts 3</a></li>
                        </ul>
                    </li>
                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link">
                        ...
                        <ul class="pc-submenu">
                            ...
                            <li class="pc-item"><a class="pc-link" href="../widget/w_data.html"
                                    data-i18n="Data">Data</a></li>
                            <li class="pc-item"><a class="pc-link" href="../widget/w_table.html"
                                    data-i18n="Tables">Table</a></li>
                            <li class="pc-item"><a class="pc-link" href="../widget/w_user.html"
                                    data-i18n="User">User</a></li>
                            <li class="pc-item"><a class="pc-link" href="../widget/w_chart.html"
                                    data-i18n="Chart">Chart</a></li>
                        </ul>
                    </li>
                    <li class="pc-item pc-caption">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <div class="bg-success bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center"
                                                    ...
                                                    <i class="ph ph-credit-card text-success"
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <div class="bg-warning bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center"
                                                    style="width: 40px; height: 40px;">
                                                    <i class="ph ph-chart-line text-warning"
                                                        style="font-size: 16px;"></i>
                                                </div>
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <div class="bg-danger bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center"
                                                    style="width: 40px; height: 40px;">
                                                    <i class="ph ph-shield-check text-danger"
                                                        style="font-size: 16px;"></i>
                                                </div>
                                            </div>
                                            <div class="flex-grow-1 ms-3">
    ...
    <div class="pct-c-btn-modern">
        <button type="button" class="customizer-trigger" data-bs-toggle="offcanvas"
            data-bs-target="#offcanvas_pc_layout" data-bs-toggle="tooltip" data-bs-placement="left"
    ...
    <div class="offcanvas border-0 pct-offcanvas-modern offcanvas-end" tabindex="-1" id="offcanvas_pc_layout">
        <div class="customizer-header">
            ...
            <div class="header-actions">
                <button type="button" class="btn-reset" id="layoutreset" data-bs-toggle="tooltip"
        ...
        <div class="quick-theme-toggle">
            ...
            <div class="theme-mode-switcher">
                ...
                <button class="theme-mode-btn" data-mode="dark" onclick="layout_change('dark');"
                    data-bs-toggle="tooltip" title="Dark Mode">
                    <i class="ph ph-moon"></i>
                    <span>Dark</span>
                </button>
            </div>
        ...
        <div class="customizer-navigation">
            <div class="nav-pills-modern" id="customizer-nav" role="tablist">
                ...
                <button class="nav-pill" id="colors-tab" data-bs-toggle="pill" data-bs-target="#colors-panel"
                    type="button" role="tab" aria-controls="colors-panel" aria-selected="false">
                    <i class="ph ph-palette"></i>
                    <span>Colors</span>
                </button>
        ...
        <div class="customizer-content">
            <div class="tab-content-modern" id="customizer-content">
                <div class="tab-pane-modern fade show active" id="layout-panel" role="tabpanel"
                    aria-labelledby="layout-tab" tabindex="0">
                            ...
                            <div class="setting-control">
                                <div class="image-toggle-group">
                                    <button class="image-toggle active" data-value="true"
                                        ...
                                        title="Show Captions">
                                        <img src="images/customizer/caption-on.svg" alt="Caption On"
                                    ...
                                    <button class="image-toggle" data-value="false"
                                        ...
                                        title="Hide Captions">
                                        <img src="images/customizer/caption-off.svg" alt="Caption Off"
                                            class="toggle-preview">
                            ...
                            <div class="setting-control">
                                <div class="image-toggle-group">
                                    <button class="image-toggle active" data-value="false"
                                        ...
                                        <img src="images/customizer/full.svg" alt="Full Width"
                                            class="toggle-preview">
                                    ...
                                    <button class="image-toggle" data-value="true"
                                        ...
                                        <img src="images/customizer/fixed.svg" alt="Fixed Width"
                                            class="toggle-preview">
                        ...
                        <div class="setting-item">
                            ...
                            <div class="setting-control">
                                <div class="color-palette preset-color">
                                    <button class="color-swatch-small active" data-bs-toggle="tooltip"
                                        title="Ocean Blue" data-value="preset-1">
                        ...
                        <div class="setting-item">
                            ...
                            <div class="setting-control">
                                <div class="icon-selector drp-menu-link-icon">
                                    ...
                                    <button class="icon-option" data-value="preset-6" data-bs-toggle="tooltip"
                                        title="Dash">
